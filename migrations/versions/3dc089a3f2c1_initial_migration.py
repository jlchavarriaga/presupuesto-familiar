...
Revision ID: 3dc089a3f2c1
Revises: 
Create Date: 2025-07-20 10:13:33.917094
...
def downgrade():
    ...
    sa.Column('descripcion', mysql.TEXT(), nullable=True),
    sa.Column('creador_id', mysql.INTEGER(), autoincrement=False, nullable=False),
    sa.CheckConstraint('(`monto_pendiente` >= 0)', name='deudas_chk_2'),
    sa.CheckConstraint('(`monto_total` > 0)', name='deudas_chk_1'),
    sa.ForeignKeyConstraint(['creador_id'], ['usuarios.id'], name='deudas_ibfk_2', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['presupuesto_id'], ['presupuestos_familiares_anuales.id'], name='deudas_ibfk_1', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    sa.ForeignKeyConstraint(['usuario_id'], ['usuarios.id'], name='categorias_gastos_ibfk_1', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    sa.Column('creador_id', mysql.INTEGER(), autoincrement=False, nullable=False),
    sa.CheckConstraint('(`monto` > 0)', name=op.f('transacciones_chk_1')),
    sa.ForeignKeyConstraint(['creador_id'], ['usuarios.id'], name=op.f('transacciones_ibfk_5'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['deuda_id'], ['deudas.id'], name=op.f('transacciones_ibfk_4'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['gasto_id'], ['gastos.id'], name=op.f('transacciones_ibfk_3'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['ingreso_id'], ['ingresos.id'], name=op.f('transacciones_ibfk_2'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['periodo_id'], ['periodos.id'], name=op.f('transacciones_ibfk_1'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    sa.Column('fecha_creacion', mysql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.Column('creador_id', mysql.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['creador_id'], ['usuarios.id'], name=op.f('presupuestos_familiares_anuales_ibfk_2'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['familia_id'], ['familias.id'], name=op.f('presupuestos_familiares_anuales_ibfk_1'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
