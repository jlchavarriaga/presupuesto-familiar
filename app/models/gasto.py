...
class Gasto(db.Model):
    ...
    # Claves foráneas
    categoria_id = db.Column(db.Integer, db.ForeignKey('categorias_gastos.id'))
    ...
    proyecciones = db.relationship('Proyeccion', back_populates='gasto')
    transacciones = db.relationship('Transaccion', back_populates='gasto')
